    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.setiRecycleritemSelectedListener(new IRecycleritemSelectedListener() {
            ...
            public void onItemSelectedListener(View view, int pos) {
                //zet achtergrond wit bij alle kaarten die niet geselecteerd zijn
                for (CardView cardView:cardViewList)
                    cardView.setCardBackgroundColor(context.getResources().getColor(android.R.color.white));

                //deze background is alleen voor de geselecteerde items
                myViewHolder.card_salon.setCardBackgroundColor(context.getResources()
                    .getColor(android.R.color.holo_orange_dark));

                //laat appointment activity weten dat de button next moet enabled worden
