...
import com.realdolmen.eindwerk.Common.SpacesItemDecoration;
import com.realdolmen.eindwerk.Interface.IAllSalonLoadListener;
import com.realdolmen.eindwerk.Interface.IBranchLoadListener;
import com.realdolmen.eindwerk.R;
import com.realdolmen.eindwerk.adapter.MySalonAdapter;
...
public class BookingStep1Fragment extends Fragment implements IAllSalonLoadListener, IBranchLoadListener {
    ...
    @BindView(R.id.spinner) //zit aan 22:22 part 4
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful())
                        {
                            ...
                            list.add("kies alstublieft een stad");
